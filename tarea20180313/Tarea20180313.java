...
public class Tarea20180313
{
    ...
    {
//        Float[][] ratings = {{2f, 5f, 6.5f, 0.1f, 6f, 8f, 5f}, {1f, 2f, 3f, 4f, 5f, 6f, 7f}, {10f, 5f, 6f, 7f, 4f, 5f, 5f}};
//        String[] nombreMatinales = {"chv", "c13", "tvn"};
    ...
    public static void mejoresMatinales(String[] nombreMatinales, Float[][] ratings)
    {
        ...
        imprimir(nombreMatinales[mejorMatinal]);
    ...
    public static void ordenarMatinales(String[] nombreMatinales, Float[][] ratings)
    {
        ...
        for(int i=0;i< nombreMatinales.length;i++)
        {
            imprimir("["+i + "] "+nombreMatinales[i] +" prom " + promedioDeMatinal(ratings[i]) );
        }
    }
